...
# Function to draw the "T" shape on the surface
def draw_t_shape(surface, position, angle, scale=25, color='LightSlateGray'):
    length = 2
    # Define vertices for the horizontal and vertical parts of the "T"
    vertices1 = [(-length*scale/2, scale),
                 (length*scale/2, scale),
                 (length*scale/2, 0),
                 (-length*scale/2, 0)]
    ...
    # Convert the vertices into pygame-friendly coordinates
    vertices1 = [(x + position[0], y + position[1]) for x, y in vertices1]
    vertices2 = [(x + position[0], y + position[1]) for x, y in vertices2]

    # Draw the horizontal and vertical parts of the "T"
    pygame.draw.polygon(surface, pygame.Color(color), vertices1)
    pygame.draw.polygon(surface, pygame.Color(color), vertices2)

# Draw the "T" shape on the surface
draw_t_shape(surface, (0, 0), 0, scale=20, color='LightSlateGray')
draw_t_shape(surface, (100, 400), 0, scale=30, color='LightSlateGray')
...
ax.set_title('T-Shape Visualization', fontsize=16, color='blue')
